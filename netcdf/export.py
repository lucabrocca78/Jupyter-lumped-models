...
grid2ts(file, shp)
sql = 'elect d."date", avg(d."temp" - 273) as temp from daily d where d."index" IN (SELECT i."index" FROM "index" i WHERE ST_Contains(ST_SetSRID(ST_GeomFromText("POLYGON((32.437134 38.950865 ,32.426147 40.178873 ,33.524780 40.279526 ,33.502808 39.715638,32.437134 38.950865))"),4326),i.geom)) group by d."date"'
